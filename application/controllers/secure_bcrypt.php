...
class Secure_bcrypt extends CI_Controller
{
    ...
    {
      parent::__construct();
      $this->load->library('bcrypt');//cargamos la librer�a
  ...
  public function register_bcrypt()
  {
    ...
    // que la generada con el m�todo token dejamos pasar
    if($this->input->post('token') && $this->input->post('token') == $this->session->userdata('token'))
    {
      ...
      $this->form_validation->set_message('min_length', 'El campo debe tener al menos 6 car�cteres');
      $this->form_validation->set_message('max_length', 'El campo no puede tener m�s de 150 car�cteres');
  ...
  public function secure_login()
  {
    ...
    if($this->input->post('token') && $this->input->post('token') == $this->session->userdata('token'))
    {
      ...
      $this->form_validation->set_message('max_length', 'El campo no puede tener m�s de 150 caracteres');
